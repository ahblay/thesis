...
%Note that $T_i$ and $T_{i+1}$ cannot exist in a diagonal configuration (as shown in Figure \ref{fig:tile_cycle}), as such a configuration creates a 4-cycle in $G[\overline{A_0}]$.
