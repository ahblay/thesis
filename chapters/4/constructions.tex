...
Unlike those presented in the previous section, the following proofs all leverage lemma \ref{lem:walls}. As a consequence, their argumentative structure remains broadly the same, even as the constructions themselves appear quite different. For this reason, we shall outline the structure here, before examining the specific proofs. 

We begin by demonstrating that a grid $G$ admits a manifold with unfolding $H$. To show that $H$ is proper, we identify the regions $R_1, \dots, R_k$ that partition $V(G) \setminus V(H)$. In our diagrams, these regions 
...
\begin{subfigure}{0.45\textwidth}
	\includegraphics[width=\textwidth]{figures/4/3x12x2_manifold_3d.pdf}
	\caption{A manifold of $G= (3,12,2)$.}
	\label{}
\end{subfigure} \hfill%
\begin{subfigure}{0.45\textwidth}
	\includegraphics[width=\textwidth]{figures/4/3x12x2_manifold.pdf}
...
Observe that $V(G) \setminus V(H)$ can be partitioned into two sets $R_1$ and $R_2$, bounded by vertices delineated by red, dashed blue and green lines, and dashed red, blue and green lines, respectively (see figure \ref{fig:3x12x2_manifold}). Therefore, $V(H)$ satisfies the conditions of \ref{cor:manifold}, and is a proper unfolding of $G$. Furthermore, consider the initial infection $A$ of $H$ illustrated in figure \ref{fig:3x12x2_unfolded_lethal}. Observe that $A$ infects all vertices of $H$ by \ref{lem:forest}, with the exception of two regions on the far left and far right. However, note that upon refolding, the two cells marked with an ``X" in $H$ represent the same cell in $G$. This is sufficient to infect the remaining regions of $H$, and by corollary \ref{cor:ortho_walls}, $A$ is lethal on $G$. Finally, a simple calculation reveals that $|A|$ matches the surface area bound, and therefore is perfect.
...
\centering
\begin{subfigure}{0.45\textwidth}
	\includegraphics[width=\textwidth]{figures/4/11x20x2_manifold_3d.pdf}
	\caption{A manifold of $G= (11,20,2)$.}
	\label{}
\end{subfigure} \hfill%
\begin{subfigure}{0.45\textwidth}
	\includegraphics[width=\textwidth]{figures/4/11x20x2_manifold.pdf}
	\caption{A proper unfolding of $G$.}
	\label{}
\end{subfigure}
...
\centering
\begin{subfigure}{0.45\textwidth}
	\includegraphics[width=\textwidth]{figures/4/12x21x2_manifold_3d.pdf}
	\caption{A manifold of $G= (12,21,2)$.}
	\label{}
\end{subfigure} \hfill%
\begin{subfigure}{0.45\textwidth}
	\includegraphics[width=\textwidth]{figures/4/12x21x2_unfolded.pdf}
	\caption{A proper unfolding of $G$.}
	\label{}
\end{subfigure}
...
\centering
\begin{subfigure}{0.45\textwidth}
	\includegraphics[width=\textwidth]{figures/4/17x25x1_manifold_3d.pdf}
	\caption{A manifold of $G= (15,23,3)$.}
	\label{}
\end{subfigure} \hfill%
\begin{subfigure}{0.45\textwidth}
	\includegraphics[width=\textwidth]{figures/4/17x25x1_manifold.pdf}
	\caption{A proper unfolding of $G$.}
	\label{}
\end{subfigure}
