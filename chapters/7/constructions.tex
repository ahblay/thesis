...
Let $L_1$, $L_2$ and $L_3$ be the top, middle and bottom levels of $G$, respectively. Consider $L_2$ at $t=1$ (see Figure \ref{fig:6x11x3}). Observe that all vertices in $X^k \cap L_2$ (with the exception of the one labeled ``X") are infected by Proposition \ref{prop:2_neighbor_levels}, due to adjacent infected vertices in $L_1$ and$L_3$. 
