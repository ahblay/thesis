...
A lower bound for the Cartesian product of two cycles is given in Benevides \cite{benevides:2021}. 
...
Not all grids have integral perimeter, or surface area, bounds. These grids are listed in Table \ref{tab:integral_bounds}. In such cases, we are guaranteed the existence of at least one cell that is infected by more than $r$ neighbors. 
