...
In 2018, Hartarsky investigated maximum $r$-neighbor percolation time on $d$-dimensional hypercubes, for $r \ge 3$ \cite{hartarsky2017maximal}. In particular, they determined the following value of $T([2]^d, r)$, up to a factor of $\log d$:
